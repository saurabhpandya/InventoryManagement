...
class ApiConstants {
    ...
    companion object {
        ...
        const val ENDPOINT_MASTER_SUB_CATEGORY_LEAFS = "subCategoryLeafs"
        ...
        const val ENDPOINT_PRODUCT_VARIANT_UPDATE = "$ENDPOINT_MASTER_PRODUCT_VARIANT/updateProductVariant"
